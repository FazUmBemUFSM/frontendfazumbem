...
import { ActionButton, ButtonsArea, InfosArea, PhotoArea, PostagemContainer, HorizontalContainerIfMobile2, NetworkButton} from './postagem-styles';
        ...
        <HorizontalContainerJustCenterAlignCenter>
          <VerticalContainerIfMobile>
            ...
            <InfosArea style={{fontFamily:"Roboto"}}>
              ...
              <div style={{fontSize: "1rem", marginLeft:"10px"}}>Esse é o status da publicação.</div>
            ...
            <ButtonsArea>
              ...
              <HorizontalContainerIfMobile2>
                <ActionButton>Ver/Editar</ActionButton>
