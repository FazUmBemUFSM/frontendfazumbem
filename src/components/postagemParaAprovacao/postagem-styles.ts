...
export const AproveButton = styled.div`

    width: 60px;
    height: 50px;
    margin:5px;
    background-color: rgba(113, 175, 97,0.5);
    ...
    &:hover{
        background-color: rgba(113, 175, 97,0.8);
    }
`;
...
export const DeleteButton = styled.div`
    ...
    height: 50px;
    margin:5px;
    background-color: rgba(188, 84, 84,0.5);
    ...
    &:hover{
        background-color: rgba(188, 84, 84,0.8);
    }
`;
